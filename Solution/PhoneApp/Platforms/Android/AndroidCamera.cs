...
{
    public partial class AndroidCamera : ObservableObject, ICameraService
    {
        #region Properties
        ...
        partial void OnExposureChanged(double value) => ApplyToBuilder();

        [ObservableProperty]
        private double gain;
        partial void OnGainChanged(double value) => ApplyToBuilder();
